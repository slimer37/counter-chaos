...
namespace UI.Settings
{
    ...
    /// </summary>
    [AddComponentMenu("Rebind Action UI (TextMeshPro)")]
    public class TMPRebindActionUI : MonoBehaviour
    {
        /// <summary>
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<TMPRebindActionUI>();
        ...
        private static List<TMPRebindActionUI> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<TMPRebindActionUI, string, string, string> { }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<TMPRebindActionUI, InputActionRebindingExtensions.RebindingOperation> { }
    }
}