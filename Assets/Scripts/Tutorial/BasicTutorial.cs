...
namespace Tutorial
{
    public class BasicTutorial : Tutorial
    {
        ...
        public override IEnumerator OnTutorialStart()
        {
            ...
            yield return textBox.Display($"You can interact with {interact}.");
            
            yield return new WaitForSeconds(1);
            
            itemToPickUp.gameObject.SetActive(true);
            locator.ShowAndFollow(itemToPickUp.transform, $"Pick up ({interact})");
            yield return textBox.Display(false, $"Find the highlighted object and pick it up with {interact}.");
            ...
            yield return textBox.Display(false, "The object was placed in your inventory.",
            ...
            yield return textBox.Display($"You can drop the item with {drop}.",
            ...
            yield return textBox.Display(false,
